...
python python /home/sharonpe/microsatellite-instability-classification/main.py --train-subtype-classification-tile

echo "Current date and time: $(date)"
echo "END"
""")
    proc = subprocess.Popen(['sbatch --exclude=Alsx2 slurm_script.sh'], shell=True)
    proc.wait()
    print('Done.')
