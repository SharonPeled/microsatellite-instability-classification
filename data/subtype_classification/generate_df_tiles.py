...
for tile_size in tile_sizes:
    ...
    df_mc = pd.read_csv(f'{DATA_FOLDER}/subtype_classification/df_manifest_all_dx_cohort_combined.tsv', sep='\t')
    ...
    if tile_size != 224:
        df_tiles_merged.to_csv(f'{DATA_FOLDER}/subtype_classification/df_processed_tile_paths_{tile_size}.csv')
    else:
        df_tiles_merged.to_csv(f'{DATA_FOLDER}/subtype_classification/df_processed_tile_paths_{tile_size}_reduced.csv')
print('Finished')
