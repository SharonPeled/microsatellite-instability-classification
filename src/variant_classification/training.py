...
def train():
    ...
    mlflow_logger = MLFlowLogger(experiment_name=Configs.VC_EXPERIMENT_NAME, run_name=Configs.VC_RUN_NAME,
    ...
    _, df_pred_path = save_pred_outputs(model.test_outputs, test_dataset, Configs.VC_TEST_BATCH_SIZE,
                                        save_path=Configs.VC_TEST_PREDICT_OUTPUT_PATH,
    ...
    for i, outputs in enumerate(model.valid_outputs):
        _, df_pred_path = save_pred_outputs(outputs, valid_dataset, Configs.VC_TEST_BATCH_SIZE,
                                            save_path=Configs.VC_VALID_PREDICT_OUTPUT_PATH,
                                            class_to_ind=Configs.VC_CLASS_TO_IND,
                                            suffix=str(i), saving_raw=True)
