...
class SubtypeClassificationConfigs:
    ...
    SC_FORMULATION = f'CV_p_ALP_FV20_2e_{SC_TILE_SIZE}'
    SC_RUN_NAME = f"SSL_VIT_{SC_FORMULATION}_33"
    ...
    Warmup 2500,
    AUG FoVs (0.20, 0.20).
    Learnable priors 0.5.
    20% random resize crop
    2 epochs, lr decay 0.1."""
    ...
    SC_KW_ARGS = {'one_hot_cohort_head': False,
                  ...
                  'FoVs_augs_amounts': (0.2, 0.2)  # tuple of % from each FoVs to add
                  }
    # MIL STUFF
