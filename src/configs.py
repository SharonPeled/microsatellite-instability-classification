...
class SubtypeClassificationConfigs:
    ...
    SC_FORMULATION = f'cls_w_LP_1.5k_CBbz_1e4_{SC_TILE_SIZE}'
    SC_RUN_NAME = f"SSL_VIT_{SC_FORMULATION}_2"
    ...
    SC_TILE_SAMPLE_LAMBDA_TRAIN = lambda self, tile_count: min(tile_count, 1750)  # all tiles
