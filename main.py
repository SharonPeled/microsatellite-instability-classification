...
from src.global_clustering.encode import encode
from src.global_clustering.cluster import cluster
import signal
import datetime
...
def main():
    ...
    parser.add_argument('--encode-tiles', action='store_true')
